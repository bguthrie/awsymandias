...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<bguthrie-aws-sdb>, [">= 0.4.0"])
      s.add_runtime_dependency(%q<grempe-amazon-ec2>, [">= 0.3.8"])
    else
      s.add_dependency(%q<activesupport>, [">= 2.3.0"])
      s.add_dependency(%q<activeresource>, [">= 2.3.0"])
      s.add_dependency(%q<bguthrie-aws-sdb>, [">= 0.4.0"])
      s.add_dependency(%q<grempe-amazon-ec2>, [">= 0.3.8"])
    end
  else
    s.add_dependency(%q<activesupport>, [">= 2.3.0"])
    s.add_dependency(%q<activeresource>, [">= 2.3.0"])
