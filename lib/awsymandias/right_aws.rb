module Awsymandias
  module RightAws
    class << self
      def connection
        @connection ||= ::RightAws::Ec2.new(Awsymandias.access_key_id,  Awsymandias.secret_access_key)
      end      
      ...
      def latest_snapshot_based_on(volume_id, raise_if_no_snapshot = true)
        ...
        snapshot_id =  snapshots_for_volume.empty? ? nil : snapshots_for_volume.sort { |a,b| a.aws_started_at <=> b.aws_started_at }.last.aws_id
